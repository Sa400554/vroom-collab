...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="inquiry.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Inquiry</a>
        </li>
      </ul>
    </div>
    </div>
  ...
  <section class="home bg-center bg-cover bg-no-repeat min-h-[35vh] relative flex flex-col justify-center items-center">
      <div class="form-container">
          <form class="flex flex-wrap items-center gap-4 bg-white p-5 rounded-md">
              <div class="input-box flex items-center">
                  <span class="font-semibold">Location</span>
                  <select class="ml-2 py-2 px-3 bg-gray-200 rounded-md w-64" id="location-select">
              ...
              <div class="input-box flex items-center">
                  ...
                  <input type="date" class="ml-2 py-2 px-3 bg-gray-200 rounded-md">
              </div>
              <div class="input-box flex items-center">
                  <span class="font-semibold">Drop-Off Date</span>
                  <input type="date" class="ml-2 py-2 px-3 bg-gray-200 rounded-md">
              </div>
              <input type="submit" class="btn py-2 px-4 bg-blue-800 text-white font-semibold rounded-md cursor-pointer transition-colors duration-300 hover:bg-main-color" value="Submit">
          </form>
      </div>
  </section>
