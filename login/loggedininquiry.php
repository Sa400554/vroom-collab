...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `inquiry` (firstname, lastname, email, phone, message) VALUES ('$firstname', '$lastname', '$email', '$phone', '$message')";
    ...
    if($result){
        ...
        // Provide error message if insertion fails
...
<body>
  ...
  <div class="relative isolate bg-white">
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      ...
      <form method="post" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-32">
