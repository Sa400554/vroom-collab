    ...
    <div class="modal fade" tabindex="-1" id="BookModel" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <figure class="figure">
                ...
                <h5 class="text-primary">Car Specifications : <hr></h5>
                ...
                <h6 class="text-primary" >Change Payment Type : </h6>
                    ...
                    <label class="alert alert-warning" id="PaymentAlart" style="padding: 0.2rem 1rem; font-size: 0.875rem;">Check This field to Select Default End Location</label>
                        <div class="form-check" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-arrow-auto" data-bs-title="Hello World">
                            ...
                            <div class="row mb-3" id="DistanceField" ><hr>
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm text-primary costumerNumber">Distance In Km : </label>
                            <div class="col-sm-8">
                                <input type="tel" class="form-control form-control-sm" id="Distance" placeholder=" (E.g. If End Location : Mustang Then 500 Km)">
                            </div>
                            <table class="table table-striped carSpecs">
                            <tbody>
                                <tr>
                        ...
                        <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm text-primary costumerNumber">Number : </label>
                            <div class="col-sm-10">
...
<script>
    ...
    $(document).on("click",".confirmOrder",function(){
        ...
        var cNum = $('#CostumerNumber').val();
            ...
            Costumer Email : ${cMail}
            Costumer Number : ${cNum}`);
            $.ajax({
                type: "POST",
                url: "CarDetails.php",
                data: {
