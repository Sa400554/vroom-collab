...
?>
  <div class="body">
        ...
        <a href="Rent.php" class="btn btn-danger sub-btn"  style="border-radius:50px; padding: 20px 40px;"><h4>Start Renting <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
    ...
    <div class="div-1">
        ...
        <p class = "dummy-foot">Lörem ipsum od ohet dilogi. Bell trabel, samuligt, ohöbel utom diska. Jinesade bel när feras redorade i belogi. FAR paratyp i muvåning, och pesask vyfisat. Viktiga poddradio har un mad och inde. </p>
